                            ...
                            <div class="span12" id="divEditarVenda">
                                <form action="<?php echo current_url(); ?>" method="post" id="formVendas">
                                    ...
                                    <div class="span3">
                                        ...
                                        <div class="span6" >
                                        <label for="observacoes">Observações para o admin</label>
                                        <input name="observacoes" class="span12"  type="text"  id="observacoes" value="<?php echo $result->observacoes ?>" />
                                    ...
                                    <div class="span12" >
                                        ...
                                        <strong>OBSERVAÇÕES PARA O CLIENTE</strong>
                                        </label>
    ...
    echo '</tr>';
                                    ...
                                    <tfoot>
                                        ...
                                        <?php if ($result->valor_desconto != 0 && $result->desconto != 0) {
                                            ...
                                            <tr>
                                                <td colspan="7" style="text-align: right"><strong>Total Com Desconto:</strong></td>
                                                <td>
