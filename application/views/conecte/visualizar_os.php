            ...
            <div class="widget-content" id="printOs">
                <div class="invoice-content">
                    ...
                    <div style="margin-top: 0; padding-top: 0">
                        ...
                        <?php if ($result->descricaoProduto != null || $result->defeito != null || $result->laudoTecnico != null || $result->marcaProdutoOs != null || $result->modeloProdutoOs != null || $result->nsProdutoOs != null || $result->observacoes) { ?>
                            ...
                            <table class="table table-condensed" id="tblProdutos">
                                ...
                                <tbody>
                                    ...
                                    foreach ($produtos as $p) {
                                        ...
                                        echo '<tr>';
                                        echo '<td style="text-align: ">' . $p->descricao . '</td>';
                                        echo '<td style="text-align: ">' . $p->marcaProduto . '</td>';
                                        echo '<td style="text-align: ">' . $p->modeloProduto . '</td>';
                                        echo '<td style="text-align: ">R$' . number_format($p->preco, 2, ',', '.') . '</td>';
                                        echo '<td style="text-align: ">' . $p->quantidade . '</td>';
                                        echo '<td style="text-align: ">R$ ' . number_format($p->subTotal, 2, ',', '.') . '</td>';
                                        echo '</tr>';
                                    } ?>
                             ...
                             <table class="table table-condensed" id="tblProdutos">
                                ...
                                <tbody>
                                    ...
                                    foreach ($servicos as $s) {
                                        ...
                                        echo '<tr>';
                                        echo '<td style="text-align: ">' . $s->nome . '</td>';
                                        echo '<td style="text-align: ">R$' . number_format($s->preco, 2, ',', '.') . '</td>';
                                        echo '<td style="text-align: ">' . $s->quantidade . '</td>';
                                        echo '<td style="text-align: ">R$ ' . number_format($s->subTotal, 2, ',', '.') . '</td>';
                                        echo '</tr>';
                                    }
                            ?>
                                    ...
                                    <tr>
                                        <td colspan="5" style="text-align: right"></td>
                                        <td style="text-align: right"><strong> Total com Desconto: R$
