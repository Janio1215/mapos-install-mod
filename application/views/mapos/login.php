...
<body>
  ...
  ?></h1>
            ...
            <img src="<?php echo base_url() ?>assets/img/dashboard-animate.svg" class="left-login-image"
                ...
                <div class="container">
                    <div class="card">
                        <div class="content">
                            ...
                            <?php $app_version = $this->config->item('app_version'); ?>
                            <div id="mcell">Versão: <?= $app_version; ?></div>
