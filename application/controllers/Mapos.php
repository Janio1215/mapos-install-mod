...
class Mapos extends MY_Controller
{
    ...
    // teste de upload imagem com nome 
    ...
    public function do_uploadCarimbo($filename = null)
{
    ...
    public function cadastrarEmitente()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $imageCarim = $this->do_uploadCarimbo();
            $logo = base_url() . 'assets/uploads/' . $image;
            $carimbo = base_url() . 'assets/img/carimbo/' . $imageCarim;

            $retorno = $this->mapos_model->addEmitente($nome, $cnpj, $ie, $cep, $logradouro, $numero, $bairro, $cidade, $uf, $telefone, $email, $logo, $carimbo);
            if ($retorno) {
